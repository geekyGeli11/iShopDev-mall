<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handlePreview()" style="margin-left: 10px;">预览效果</el-button>
      <el-button size="mini" class="btn-add" @click="handleSelectProduct()" style="margin-left: 10px;">选择商品</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="newProductTable" :data="list" style="width: 100%;" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="推广封面" width="120" align="center">
    ...
    <el-dialog title="编辑" :visible.sync="sortDialogVisible" width="40%">
      <el-form :model="sortDialogData" label-width="150px">
        ...
        <el-form-item label="关联学校：">
          <el-select v-model="sortDialogData.schoolId" placeholder="请选择学校" clearable style="width: 200px">
            <el-option label="全平台通用" :value="null"></el-option>
            <el-option
              v-for="school in schoolOptions"
              :key="school.id"
  ...
  export default {
    ...
    data() {
      return {
        ...
        sortDialogData:{sort:0,cover:null,id:null,schoolId:null}
      }
    },
    created() {
      this.getList();
    ...
    methods: {
      ...
      handleEditSort(index,row){
        ...
        this.sortDialogData.schoolId=row.schoolId;
      },
      handleUpdateSort(){
