<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleShowSessionList()">限时优惠时间段列表</el-button>
    </el-card>
    ...
    <el-dialog
      ...
      <el-form :model="flashPromotion"
        ...
        <el-form-item label="关联学校：">
          <el-select v-model="flashPromotion.schoolId" placeholder="请选择学校" clearable style="width: 250px">
            <el-option label="全平台通用" :value="null"></el-option>
            <el-option
              v-for="school in schoolOptions"
              :key="school.id"
