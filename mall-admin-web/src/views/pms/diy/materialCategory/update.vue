<template>
  <div class="app-container">
    ...
    <el-breadcrumb class="app-breadcrumb" separator="/">
      ...
      <el-breadcrumb-item>编辑DIY素材分类</el-breadcrumb-item>
    </el-breadcrumb>

    <!-- 表单区域 -->
    <el-card class="form-container" shadow="never" v-loading="formLoading">
      <el-form
...
<script>
import { getMaterialCategory, updateMaterialCategory } from '@/api/diyMaterial'
...
export default {
  ...
  created() {
    if (this.$route.query.id != null && this.$route.query.id !== '') {
      this.materialCategory.id = this.$route.query.id
  ...
  methods: {
    getMaterialCategory() {
      ...
      getMaterialCategory(this.materialCategory.id).then(response => {
    ...
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          updateMaterialCategory(this.materialCategory.id, this.materialCategory).then(response => {
