...
public class EsProductController {
    ...
    @Parameter(name = "sort", description = "排序字段:0->综合推荐；1->按新品；2->按销量；3->价格从低到高；4->价格从高到低", in = ParameterIn.QUERY, schema = @Schema(type = "integer",defaultValue = "0",allowableValues = {"0","1","2","3","4"}))
