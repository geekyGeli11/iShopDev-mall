...
public class SmsHomeRecommendSubjectServiceImpl implements SmsHomeRecommendSubjectService {
    ...
    @Override
    public int updateSort(Long id, Integer sort, String cover, String subjectDescription, String picsAlbum) {
        SmsHomeRecommendSubject recommendProduct = new SmsHomeRecommendSubject();
        recommendProduct.setId(id);
        recommendProduct.setSort(sort);
        recommendProduct.setCover(cover);
        recommendProduct.setSubjectDescription(subjectDescription);
        recommendProduct.setPicsAlbum(picsAlbum);
    ...
    public List<SmsHomeRecommendSubject> list(String subjectName, Integer recommendStatus, Integer pageSize, Integer pageNum) {
        ...
        return recommendProductMapper.selectByExampleWithBLOBs(example);
    }
}