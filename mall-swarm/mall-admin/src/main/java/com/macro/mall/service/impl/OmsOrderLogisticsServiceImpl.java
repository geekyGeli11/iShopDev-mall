...
public class OmsOrderLogisticsServiceImpl implements OmsOrderLogisticsService {
    ...
    @Override
    public OmsOrderLogisticsInfo getLogisticsInfo(Long orderId) throws Exception {
        // 获取订单的物流公司和物流单号
        OrderLogistics orderDetail = orderLogisticsDao.getOrderLogisticsByOrderId(orderId);
        ...
        if (jsonResponse.has("result") && !jsonResponse.getBoolean("result")) {
            ...
            OmsOrderLogisticsInfo logisticsInfoDTO = new OmsOrderLogisticsInfo();
