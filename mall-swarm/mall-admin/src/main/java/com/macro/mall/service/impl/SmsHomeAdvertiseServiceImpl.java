...
public class SmsHomeAdvertiseServiceImpl implements SmsHomeAdvertiseService {
    ...
    public List<SmsHomeAdvertise> list(String name, Integer type, String endTime, Integer pageSize, Integer pageNum) {
        return list(name, type, endTime, null, pageSize, pageNum);
    }

    @Override
    public List<SmsHomeAdvertise> list(String name, Integer type, String endTime, Long schoolId, Integer pageSize, Integer pageNum) {
