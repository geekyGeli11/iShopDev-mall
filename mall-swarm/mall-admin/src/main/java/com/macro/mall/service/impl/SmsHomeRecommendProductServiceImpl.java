...
public class SmsHomeRecommendProductServiceImpl implements SmsHomeRecommendProductService {
    ...
    public int updateSort(Long id, Integer sort, String cover, Long schoolId) {
        ...
        recommendProduct.setSort(sort);
        recommendProduct.setCover(cover);
        recommendProduct.setSchoolId(schoolId);
        return recommendProductMapper.updateByPrimaryKeySelective(recommendProduct);
    }
    ...
    @Override
    public List<SmsHomeRecommendProduct> list(String productName, Integer recommendStatus, Long schoolId, Integer pageSize, Integer pageNum) {
