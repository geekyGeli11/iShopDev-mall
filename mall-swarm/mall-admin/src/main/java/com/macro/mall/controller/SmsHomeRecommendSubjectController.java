...
public class SmsHomeRecommendSubjectController {
    ...
    @ResponseBody
    public CommonResult updateSort(@PathVariable Long id, Integer sort, String cover, String subjectDescription, String picsAlbum) {
        int count = recommendSubjectService.updateSort(id, sort, cover, subjectDescription, picsAlbum);
        if (count > 0) {
            return CommonResult.success(count);
        }
        return CommonResult.failed();
