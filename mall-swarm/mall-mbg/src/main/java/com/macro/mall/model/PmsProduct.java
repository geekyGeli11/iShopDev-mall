...
public class PmsProduct implements Serializable {
    ...
    @Schema(title = "支持的购买方式：0->快递发货和线下自提；1->仅线下自提")
    private Boolean purchaseType;

    @Schema(title = "回本目标销售数量")
    private Integer paybackTargetQuantity;

    @Schema(title = "回本目标金额")
    private BigDecimal paybackTargetAmount;

    @Schema(title = "回本开始日期（商品上架日期）")
    private Date paybackStartDate;

    @Schema(title = "是否启用回本分析：0-否，1-是")
    private Boolean enablePaybackAnalysis;
    ...
    public Integer getPaybackTargetQuantity() {
        return paybackTargetQuantity;
    }

    public void setPaybackTargetQuantity(Integer paybackTargetQuantity) {
        this.paybackTargetQuantity = paybackTargetQuantity;
    }

    public BigDecimal getPaybackTargetAmount() {
        return paybackTargetAmount;
    }

    public void setPaybackTargetAmount(BigDecimal paybackTargetAmount) {
        this.paybackTargetAmount = paybackTargetAmount;
    }
    ...
    public Boolean getEnablePaybackAnalysis() {
        return enablePaybackAnalysis;
    }

    public void setEnablePaybackAnalysis(Boolean enablePaybackAnalysis) {
        this.enablePaybackAnalysis = enablePaybackAnalysis;
    }
    ...
    public String toString() {
        ...
        sb.append(", paybackTargetQuantity=").append(paybackTargetQuantity);
        sb.append(", paybackTargetAmount=").append(paybackTargetAmount);
        sb.append(", paybackStartDate=").append(paybackStartDate);
        sb.append(", enablePaybackAnalysis=").append(enablePaybackAnalysis);
        sb.append(", freightTemplateId=").append(freightTemplateId);
        sb.append(", diyEnabled=").append(diyEnabled);
        sb.append(", diyTemplateId=").append(diyTemplateId);
