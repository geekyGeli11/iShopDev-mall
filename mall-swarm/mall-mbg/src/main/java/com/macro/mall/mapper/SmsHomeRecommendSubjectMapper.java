...
public interface SmsHomeRecommendSubjectMapper {
    ...
    List<SmsHomeRecommendSubject> selectByExampleWithBLOBs(SmsHomeRecommendSubjectExample example);
    ...
    int updateByExampleWithBLOBs(@Param("row") SmsHomeRecommendSubject row, @Param("example") SmsHomeRecommendSubjectExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(SmsHomeRecommendSubject row);
