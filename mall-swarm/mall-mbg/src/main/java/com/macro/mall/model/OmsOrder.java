...
public class OmsOrder implements Serializable {
    ...
    @Schema(title = "订单来源：0->PC订单；1->小程序订单，2-自助设备订单")
    ...
    @Schema(title = "配送类型 0-快递配送，1-上门自取")
    ...
    @Schema(title = "自提门店详细地址")
    private String storeAddress;

    @Schema(title = "门店联系电话")
    private String storePhone;

    @Schema(title = "是否为送礼订单 0-不是，1- 是")
    private Boolean isGift;

    @Schema(title = "核销码")
    private String pickupCode;

    @Schema(title = "核销状态 0-未核销 1-已核销")
    ...
    @Schema(title = "售后状态：0->无售后；1->售后申请中；2->售后处理中；3->售后完成；4->售后拒绝")
    private Integer afterSaleStatus;

    @Schema(title = "订单来源学校ID")
    ...
    public Long getSourceSchoolId() {
        return sourceSchoolId;
    }

    public void setSourceSchoolId(Long sourceSchoolId) {
        this.sourceSchoolId = sourceSchoolId;
    }

    public String getVirtualDeliveryInfo() {
        return virtualDeliveryInfo;
    }

    public void setVirtualDeliveryInfo(String virtualDeliveryInfo) {
        this.virtualDeliveryInfo = virtualDeliveryInfo;
    }
    ...
    public String toString() {
        ...
        sb.append(", pickupOperator=").append(pickupOperator);
        sb.append(", afterSaleStatus=").append(afterSaleStatus);
        sb.append(", sourceSchoolId=").append(sourceSchoolId);
        sb.append(", virtualDeliveryInfo=").append(virtualDeliveryInfo);
